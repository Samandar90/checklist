...
INSERT INTO "new_MonthlyReport" ("adminId", "branchId", "createdAt", "currency", "date", "id", "notes", "price", "roomId", "sourceId") SELECT "adminId", "branchId", "createdAt", "currency", "date", "id", "notes", "price", "roomId", "sourceId" FROM "MonthlyReport";
