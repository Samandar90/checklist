...
| 15 | ~~**Умное распределение**~~ | подбор комнат | **Удалён** (2026-09-19) | — | — | — | страница, маршрут `/smart-assign` и пункты меню убраны из проекта |
...
- **Страницы (24):** перечислены в Фазе 2. Роутинг по ролям корректный: `/staff, /my-*` — ADMIN; управление — SUPER_ADMIN; календарь/касса — оба.
